...
- Buzz Git operations reset ambient credential-helper chains, bind the exact HTTPS authority including nondefault ports, use descriptor-snapshotted private key files, and rebind copied key references after atomic snapshot relocation.
